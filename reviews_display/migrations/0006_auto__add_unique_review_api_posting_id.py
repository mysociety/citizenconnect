...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Review', fields ['api_posting_id']
        db.create_unique('reviews_display_review', ['api_posting_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Review', fields ['api_posting_id']
        db.delete_unique('reviews_display_review', ['api_posting_id'])
