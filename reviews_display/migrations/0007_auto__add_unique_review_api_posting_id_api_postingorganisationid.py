...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Review', fields ['api_posting_id', 'api_postingorganisationid']
        db.create_unique('reviews_display_review', ['api_posting_id', 'api_postingorganisationid'])


    def backwards(self, orm):
        # Removing unique constraint on 'Review', fields ['api_posting_id', 'api_postingorganisationid']
        db.delete_unique('reviews_display_review', ['api_posting_id', 'api_postingorganisationid'])
    ...
    models = {
        ...
        'reviews_display.review': {
            ...
            'api_posting_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'}),
