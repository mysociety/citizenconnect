...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Rating'
        db.create_table('reviews_display_rating', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('review', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reviews_display.Review'])),
        ...
        db.send_create_signal('reviews_display', ['Rating'])


    def backwards(self, orm):
        # Deleting model 'Rating'
        db.delete_table('reviews_display_rating')
    ...
    models = {
        ...
        'reviews_display.rating': {
            ...
            'review': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['reviews_display.Review']"}),
