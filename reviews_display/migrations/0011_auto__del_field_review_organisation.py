...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Review.organisation'
        db.delete_column('reviews_display_review', 'organisation_id')


    def backwards(self, orm):
        # Adding field 'Review.organisation'
        db.add_column('reviews_display_review', 'organisation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='reviews', to=orm['organisations.Organisation']),
                      keep_default=False)
