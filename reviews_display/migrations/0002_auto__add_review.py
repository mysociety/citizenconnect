...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reviews_display_review', (
            ...
            ('api_posting_id', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('api_postingorganisationid', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('api_published', self.gf('django.db.models.fields.DateTimeField')()),
            ('api_updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('api_category', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('organisation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisations.Organisation'])),
            ('author_display_name', self.gf('django.db.models.fields.TextField')()),
            ('title', self.gf('django.db.models.fields.TextField')()),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('reviews_display', ['Review'])


    def backwards(self, orm):
        # Deleting model 'Review'
        db.delete_table('reviews_display_review')
