...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Rating', fields ['question']
        db.create_index('reviews_display_rating', ['question'])

        # Adding index on 'Review', fields ['api_published']
        db.create_index('reviews_display_review', ['api_published'])


    def backwards(self, orm):
        # Removing index on 'Review', fields ['api_published']
        db.delete_index('reviews_display_review', ['api_published'])

        # Removing index on 'Rating', fields ['question']
        db.delete_index('reviews_display_rating', ['question'])
    ...
    models = {
        ...
        'reviews_display.rating': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'question': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'db_index': 'True'}),
        ...
        'reviews_display.review': {
            ...
            'api_published': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
