...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('questions_question', 'organisation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['organisations.Organisation']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.organisation'
        db.delete_column('questions_question', 'organisation_id')
