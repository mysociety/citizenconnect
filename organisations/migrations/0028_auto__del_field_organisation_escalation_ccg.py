...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Organisation.escalation_ccg'
        raise RuntimeError("Cannot reverse this migration. 'Organisation.escalation_ccg' and its values cannot be restored.")
