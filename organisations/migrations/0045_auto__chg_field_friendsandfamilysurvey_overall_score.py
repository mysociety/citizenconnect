...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FriendsAndFamilySurvey.overall_score'
        db.alter_column('organisations_friendsandfamilysurvey', 'overall_score', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'FriendsAndFamilySurvey.overall_score'
        db.alter_column('organisations_friendsandfamilysurvey', 'overall_score', self.gf('django.db.models.fields.PositiveIntegerField')())
