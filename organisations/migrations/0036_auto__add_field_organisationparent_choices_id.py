...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganisationParent.choices_id'
        db.add_column('organisations_organisationparent', 'choices_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganisationParent.choices_id'
        db.delete_column('organisations_organisationparent', 'choices_id')
