...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for model in orm.CCG, orm.OrganisationParent:
            model.objects.filter(email="").update(email=settings.FEEDBACK_EMAIL_ADDRESS)

    def backwards(self, orm):
        for model in orm.CCG, orm.OrganisationParent:
            model.objects.filter(email=settings.FEEDBACK_EMAIL_ADDRESS).update(email="")
