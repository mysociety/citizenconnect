...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organisation.ods_code'
        db.alter_column('organisations_organisation', 'ods_code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=12))

    def backwards(self, orm):

        # Changing field 'Organisation.ods_code'
        db.alter_column('organisations_organisation', 'ods_code', self.gf('django.db.models.fields.CharField')(max_length=8, unique=True))
