...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganisationParent.active'
        db.add_column('organisations_organisationparent', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganisationParent.active'
        db.delete_column('organisations_organisationparent', 'active')
