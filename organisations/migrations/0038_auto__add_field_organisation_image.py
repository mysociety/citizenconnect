...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.image'
        db.add_column('organisations_organisation', 'image',
                      self.gf('sorl.thumbnail.fields.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.image'
        db.delete_column('organisations_organisation', 'image')
