...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Organisation.ccg'
        db.delete_column('organisations_organisation', 'ccg_id')

        # Adding field 'Organisation.escalation_ccg'
        db.add_column('organisations_organisation', 'escalation_ccg',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['organisations.CCG']),
                      keep_default=False)

        # Adding M2M table for field ccgs on 'Organisation'
        db.create_table('organisations_organisation_ccgs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organisation', models.ForeignKey(orm['organisations.organisation'], null=False)),
            ('ccg', models.ForeignKey(orm['organisations.ccg'], null=False))
        ))
        db.create_unique('organisations_organisation_ccgs', ['organisation_id', 'ccg_id'])


    def backwards(self, orm):
        # Adding field 'Organisation.ccg'
        db.add_column('organisations_organisation', 'ccg',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisations.CCG'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Organisation.escalation_ccg'
        db.delete_column('organisations_organisation', 'escalation_ccg_id')

        # Removing M2M table for field ccgs on 'Organisation'
        db.delete_table('organisations_organisation_ccgs')
    ...
    models = {
        ...
        'organisations.organisation': {
            ...
            'escalation_ccg': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['organisations.CCG']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {}),
