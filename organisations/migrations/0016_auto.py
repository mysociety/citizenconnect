...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field users on 'CCG'
        db.create_table('organisations_ccg_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ccg', models.ForeignKey(orm['organisations.ccg'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('organisations_ccg_users', ['ccg_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field users on 'CCG'
        db.delete_table('organisations_ccg_users')
