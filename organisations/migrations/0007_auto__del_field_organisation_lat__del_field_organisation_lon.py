...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Organisation.lat'
        db.delete_column('organisations_organisation', 'lat')

        # Deleting field 'Organisation.lon'
        db.delete_column('organisations_organisation', 'lon')


    def backwards(self, orm):
        # Adding field 'Organisation.lat'
        db.add_column('organisations_organisation', 'lat',
                      self.gf('django.db.models.fields.FloatField')(default=None),
                      keep_default=False)

        # Adding field 'Organisation.lon'
        db.add_column('organisations_organisation', 'lon',
                      self.gf('django.db.models.fields.FloatField')(default=None),
                      keep_default=False)
