...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.point'
        db.add_column('organisations_organisation', 'point',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.point'
        db.delete_column('organisations_organisation', 'point')
