...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CCG.intro_email_sent'
        db.add_column('organisations_ccg', 'intro_email_sent',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CCG.intro_email_sent'
        db.delete_column('organisations_ccg', 'intro_email_sent')
