...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Service', fields ['service_code']
        db.create_index('organisations_service', ['service_code'])


    def backwards(self, orm):
        # Removing index on 'Service', fields ['service_code']
        db.delete_index('organisations_service', ['service_code'])
