...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FriendsAndFamilySurvey.unlikely'
        db.add_column('organisations_friendsandfamilysurvey', 'unlikely',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FriendsAndFamilySurvey.unlikely'
        db.delete_column('organisations_friendsandfamilysurvey', 'unlikely')
