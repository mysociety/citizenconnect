...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trust.secondary_email'
        db.add_column('organisations_trust', 'secondary_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=254, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trust.secondary_email'
        db.delete_column('organisations_trust', 'secondary_email')
