...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Trust'
        db.create_table('organisations_trust', (
            ...
            ('escalation_ccg', self.gf('django.db.models.fields.related.ForeignKey')(related_name='escalation_trusts', to=orm['organisations.CCG'])),
        ))
        db.send_create_signal('organisations', ['Trust'])

        # Adding M2M table for field users on 'Trust'
        db.create_table('organisations_trust_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('trust', models.ForeignKey(orm['organisations.trust'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('organisations_trust_users', ['trust_id', 'user_id'])

        # Adding M2M table for field ccgs on 'Trust'
        db.create_table('organisations_trust_ccgs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('trust', models.ForeignKey(orm['organisations.trust'], null=False)),
            ('ccg', models.ForeignKey(orm['organisations.ccg'], null=False))
        ))
        db.create_unique('organisations_trust_ccgs', ['trust_id', 'ccg_id'])


    def backwards(self, orm):
        # Deleting model 'Trust'
        db.delete_table('organisations_trust')

        # Removing M2M table for field users on 'Trust'
        db.delete_table('organisations_trust_users')

        # Removing M2M table for field ccgs on 'Trust'
        db.delete_table('organisations_trust_ccgs')
