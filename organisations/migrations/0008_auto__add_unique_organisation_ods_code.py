...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Organisation', fields ['ods_code']
        db.create_unique('organisations_organisation', ['ods_code'])


    def backwards(self, orm):
        # Removing unique constraint on 'Organisation', fields ['ods_code']
        db.delete_unique('organisations_organisation', ['ods_code'])
