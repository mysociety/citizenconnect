...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index('organisations_organisation', ['name'])

        # Adding index on 'Service', fields ['name']
        db.create_index('organisations_service', ['name'])


    def backwards(self, orm):
        # Removing index on 'Service', fields ['name']
        db.delete_index('organisations_service', ['name'])

        # Removing index on 'Organisation', fields ['name']
        db.delete_index('organisations_organisation', ['name'])
