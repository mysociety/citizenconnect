...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('organisations_organisationparent', 'escalation_ccg_id', 'primary_ccg_id')
        db.alter_column(
            'organisations_organisationparent',
            'primary_ccg_id',
            self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisations.CCG'])
        )

    def backwards(self, orm):
        db.rename_column('organisations_organisationparent', 'primary_ccg_id', 'escalation_ccg_id')
        db.alter_column(
            'organisations_organisationparent',
            'escalation_ccg_id',
            self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisations.CCG'])
    ...
    models = {
        ...
        'organisations.organisationparent': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {}),
            'primary_ccg': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'escalation_organisation_parents'", 'to': "orm['organisations.CCG']"}),
