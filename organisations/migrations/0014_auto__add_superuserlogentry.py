...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SuperuserLogEntry'
        db.create_table('organisations_superuserlogentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='superuser_access_logs', to=orm['auth.User'])),
            ('path', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('organisations', ['SuperuserLogEntry'])


    def backwards(self, orm):
        # Deleting model 'SuperuserLogEntry'
        db.delete_table('organisations_superuserlogentry')
