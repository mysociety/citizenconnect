...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('organisations_organisation_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organisation', models.ForeignKey(orm['organisations.organisation'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('organisations_organisation_users', ['organisation_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field users on 'Organisation'
        db.delete_table('organisations_organisation_users')
