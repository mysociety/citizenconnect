...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Organisation.secondary_email'
        db.delete_column('organisations_organisation', 'secondary_email')

        # Deleting field 'Organisation.email'
        db.delete_column('organisations_organisation', 'email')


    def backwards(self, orm):
        # Adding field 'Organisation.secondary_email'
        db.add_column('organisations_organisation', 'secondary_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=254, blank=True),
                      keep_default=False)

        # Adding field 'Organisation.email'
        db.add_column('organisations_organisation', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=254, blank=True),
                      keep_default=False)
