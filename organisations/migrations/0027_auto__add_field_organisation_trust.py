...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.trust'
        db.add_column('organisations_organisation', 'trust',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='organisations', to=orm['organisations.Trust']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.trust'
        db.delete_column('organisations_organisation', 'trust_id')
