...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.org_type'
        db.add_column('reviews_submit_question', 'org_type',
                      self.gf('django.db.models.fields.CharField')(default='hospitals', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.org_type'
        db.delete_column('reviews_submit_question', 'org_type')
