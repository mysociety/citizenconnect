...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rating.answer'
        db.alter_column('reviews_submit_rating', 'answer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reviews_submit.Answer'], null=True))

    def backwards(self, orm):

        # Changing field 'Rating.answer'
        db.alter_column('reviews_submit_rating', 'answer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['reviews_submit.Answer']))
