...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.last_sent_to_api'
        db.add_column('reviews_submit_review', 'last_sent_to_api',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.last_sent_to_api'
        db.delete_column('reviews_submit_review', 'last_sent_to_api')
