...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.api_question_id'
        db.add_column('reviews_submit_question', 'api_question_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Answer.value'
        db.delete_column('reviews_submit_answer', 'value')

        # Adding field 'Answer.api_answer_id'
        db.add_column('reviews_submit_answer', 'api_answer_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.api_question_id'
        db.delete_column('reviews_submit_question', 'api_question_id')

        # Adding field 'Answer.value'
        db.add_column('reviews_submit_answer', 'value',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Answer.api_answer_id'
        db.delete_column('reviews_submit_answer', 'api_answer_id')
