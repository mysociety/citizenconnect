...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Review.email'
        db.alter_column('reviews_submit_review', 'email', self.gf('django.db.models.fields.EmailField')(max_length=254))

    def backwards(self, orm):

        # Changing field 'Review.email'
        db.alter_column('reviews_submit_review', 'email', self.gf('django.db.models.fields.CharField')(max_length=100))
