...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Review', fields ['last_sent_to_api']
        db.create_index('reviews_submit_review', ['last_sent_to_api'])


    def backwards(self, orm):
        # Removing index on 'Review', fields ['last_sent_to_api']
        db.delete_index('reviews_submit_review', ['last_sent_to_api'])
    ...
    models = {
        ...
        'reviews_submit.review': {
            ...
            'last_sent_to_api': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
