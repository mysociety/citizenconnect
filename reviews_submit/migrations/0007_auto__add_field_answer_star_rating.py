...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.star_rating'
        db.add_column('reviews_submit_answer', 'star_rating',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.star_rating'
        db.delete_column('reviews_submit_answer', 'star_rating')
