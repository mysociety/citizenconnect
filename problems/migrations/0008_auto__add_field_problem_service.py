...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Problem.service'
        db.add_column('problems_problem', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisations.Service'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Problem.service'
        db.delete_column('problems_problem', 'service_id')
    ...
    models = {
        ...
        'problems.problem': {
            ...
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['organisations.Service']", 'null': 'True'}),
