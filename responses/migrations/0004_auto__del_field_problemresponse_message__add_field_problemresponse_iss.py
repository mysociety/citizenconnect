...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'ProblemResponse.message_id' to 'issue_id'
        db.rename_column('responses_problemresponse', 'message_id', 'issue_id')

    def backwards(self, orm):
        # Renaming field 'ProblemResponse.issue_id' to 'message_id'
        db.rename_column('responses_problemresponse', 'issue_id', 'message_id')
    ...
    models = {
        ...
        'responses.problemresponse': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'responses'", 'to': "orm['issues.Problem']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
