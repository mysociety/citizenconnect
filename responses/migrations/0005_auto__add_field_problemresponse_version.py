...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProblemResponse.version'
        db.add_column('responses_problemresponse', 'version',
                      self.gf('concurrency.fields.IntegerVersionField')(name='version', db_tablespace=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProblemResponse.version'
        db.delete_column('responses_problemresponse', 'version')
