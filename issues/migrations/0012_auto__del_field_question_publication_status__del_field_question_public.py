...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.publication_status'
        db.delete_column('issues_question', 'publication_status')

        # Deleting field 'Question.public'
        db.delete_column('issues_question', 'public')

        # Deleting field 'Question.public_reporter_name'
        db.delete_column('issues_question', 'public_reporter_name')
    ...
    def backwards(self, orm):
        # Adding field 'Question.publication_status'
        db.add_column('issues_question', 'publication_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Question.public'
        db.add_column('issues_question', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Question.public_reporter_name'
        db.add_column('issues_question', 'public_reporter_name',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
