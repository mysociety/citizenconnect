...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Problem.relates_to_previous_problem'
        db.add_column('issues_problem', 'relates_to_previous_problem',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Problem.relates_to_previous_problem'
        db.delete_column('issues_problem', 'relates_to_previous_problem')
    ...
    models = {
        ...
        'issues.problem': {
            ...
            'relates_to_previous_problem': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
