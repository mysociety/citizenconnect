...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.reporter_phone'
        db.delete_column('issues_question', 'reporter_phone')

        # Deleting field 'Question.preferred_contact_method'
        db.delete_column('issues_question', 'preferred_contact_method')


    def backwards(self, orm):
        # Adding field 'Question.reporter_phone'
        db.add_column('issues_question', 'reporter_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Question.preferred_contact_method'
        db.add_column('issues_question', 'preferred_contact_method',
    ...
    models = {
        ...
        'issues.problem': {
            ...
            'cobrand': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
        ...
        'issues.question': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'organisation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['organisations.Organisation']", 'null': 'True', 'blank': 'True'}),
