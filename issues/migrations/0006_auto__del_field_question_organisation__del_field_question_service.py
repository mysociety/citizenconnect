...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.organisation'
        db.delete_column('issues_question', 'organisation_id')

        # Deleting field 'Question.service'
        db.delete_column('issues_question', 'service_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Question.organisation'
        raise RuntimeError("Cannot reverse this migration. 'Question.organisation' and its values cannot be restored.")
        # Adding field 'Question.service'
        db.add_column('issues_question', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisations.Service'], null=True, blank=True),
                      keep_default=False)
