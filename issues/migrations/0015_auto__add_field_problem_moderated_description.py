...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Problem.moderated_description'
        db.add_column('issues_problem', 'moderated_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Problem.moderated_description'
        db.delete_column('issues_problem', 'moderated_description')
