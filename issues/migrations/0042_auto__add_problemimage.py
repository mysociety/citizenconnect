...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProblemImage'
        db.create_table('issues_problemimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('problem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Problem'])),
        ))
        db.send_create_signal('issues', ['ProblemImage'])


    def backwards(self, orm):
        # Deleting model 'ProblemImage'
        db.delete_table('issues_problemimage')
    ...
    models = {
        ...
        'issues.problemimage': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'problem': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['issues.Problem']"})
        },
        'organisations.ccg': {
