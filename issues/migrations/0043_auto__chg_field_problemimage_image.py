...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProblemImage.image'
        db.alter_column('issues_problemimage', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ProblemImage.image'
        db.alter_column('issues_problemimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
