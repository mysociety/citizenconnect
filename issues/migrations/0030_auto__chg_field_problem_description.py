...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Problem.description'
        db.alter_column('issues_problem', 'description', self.gf('django.db.models.fields.TextField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'Problem.description'
        db.alter_column('issues_problem', 'description', self.gf('django.db.models.fields.TextField')())
