...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Problem.commissioned'
        db.add_column('issues_problem', 'commissioned',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Problem.commissioned'
        db.delete_column('issues_problem', 'commissioned')
