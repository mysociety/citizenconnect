...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("responses", "0005_auto__add_field_problemresponse_version"),
    )
    ...
    def backwards(self, orm):
        ...
        db.create_table('issues_question', (
            ...
            ('organisation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisations.Organisation'], null=True, blank=True)),
