...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Problem.requires_legal_moderation'
        db.delete_column('issues_problem', 'requires_legal_moderation')

        # Adding field 'Problem.requires_second_tier_moderation'
        db.add_column('issues_problem', 'requires_second_tier_moderation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Problem.requires_legal_moderation'
        db.add_column('issues_problem', 'requires_legal_moderation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Problem.requires_second_tier_moderation'
        db.delete_column('issues_problem', 'requires_second_tier_moderation')
