...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Problem.reporter_under_16'
        db.add_column('issues_problem', 'reporter_under_16',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Problem.reporter_under_16'
        db.delete_column('issues_problem', 'reporter_under_16')
