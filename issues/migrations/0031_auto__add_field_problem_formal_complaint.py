...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Problem.formal_complaint'
        db.add_column('issues_problem', 'formal_complaint',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Problem.formal_complaint'
        db.delete_column('issues_problem', 'formal_complaint')
