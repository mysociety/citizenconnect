...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Problem.legal_moderation_status'
        db.delete_column('issues_problem', 'legal_moderation_status')
    ...
    def backwards(self, orm):
        # Adding field 'Problem.legal_moderation_status'
        db.add_column('issues_problem', 'legal_moderation_status',
    ...
    models = {
        ...
        'issues.problem': {
            ...
            'requires_legal_moderation': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
