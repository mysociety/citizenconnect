...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Problem.reporter_email'
        db.alter_column('issues_problem', 'reporter_email', self.gf('django.db.models.fields.EmailField')(max_length=254))

    def backwards(self, orm):

        # Changing field 'Problem.reporter_email'
        db.alter_column('issues_problem', 'reporter_email', self.gf('django.db.models.fields.CharField')(max_length=254))
