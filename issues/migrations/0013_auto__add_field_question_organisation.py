...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.organisation'
        db.add_column('issues_question', 'organisation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisations.Organisation'], null=True, blank=True),
                      keep_default=False)
