...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Problem.public_reporter_name_original'
        db.add_column('issues_problem', 'public_reporter_name_original',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Problem.public_reporter_name_original'
        db.delete_column('issues_problem', 'public_reporter_name_original')
