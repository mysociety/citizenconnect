...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Problem.publication_status'
        db.add_column('issues_problem', 'publication_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Problem.publication_status'
        db.delete_column('issues_problem', 'publication_status')
