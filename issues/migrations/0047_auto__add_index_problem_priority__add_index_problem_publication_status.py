...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Problem', fields ['priority']
        db.create_index('issues_problem', ['priority'])

        # Adding index on 'Problem', fields ['publication_status']
        db.create_index('issues_problem', ['publication_status'])

        # Adding index on 'Problem', fields ['mailed']
        db.create_index('issues_problem', ['mailed'])


    def backwards(self, orm):
        # Removing index on 'Problem', fields ['mailed']
        db.delete_index('issues_problem', ['mailed'])

        # Removing index on 'Problem', fields ['publication_status']
        db.delete_index('issues_problem', ['publication_status'])

        # Removing index on 'Problem', fields ['priority']
        db.delete_index('issues_problem', ['priority'])
