...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('issues_question', 'category')


    def backwards(self, orm):
        # Adding field 'Question.category'
        db.add_column('issues_question', 'category',
                      self.gf('django.db.models.fields.CharField')(default='general', max_length=100, db_index=True),
                      keep_default=False)
