...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ProblemImage', fields ['created']
        db.create_index('issues_problemimage', ['created'])

        # Adding index on 'Problem', fields ['created']
        db.create_index('issues_problem', ['created'])


    def backwards(self, orm):
        # Removing index on 'Problem', fields ['created']
        db.delete_index('issues_problem', ['created'])

        # Removing index on 'ProblemImage', fields ['created']
        db.delete_index('issues_problemimage', ['created'])
