...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Problem.happy_service'
        db.add_column('issues_problem', 'happy_service',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Problem.happy_outcome'
        db.add_column('issues_problem', 'happy_outcome',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Problem.happy_service'
        db.delete_column('issues_problem', 'happy_service')

        # Deleting field 'Problem.happy_outcome'
        db.delete_column('issues_problem', 'happy_outcome')
