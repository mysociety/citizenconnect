...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Problem.confirmation_required'
        db.add_column('issues_problem', 'confirmation_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Problem.confirmation_required'
        db.delete_column('issues_problem', 'confirmation_required')
